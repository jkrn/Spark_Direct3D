...
const COLOR attackCylinderColor(1.0f, 0.0f, 0.0f, 0.25f);
...
// Attack
const double attack_ratio = 0.25;
const double attack_radius_XY = playerRadius_XY * 2.0;
const double attack_radius_Z = playerRadius_Z;
// Text
